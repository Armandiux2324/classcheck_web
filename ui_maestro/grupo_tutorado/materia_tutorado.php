...
<head>
    ...
    $query_grupo = "SELECT * FROM grupos WHERE id_grupo = ?";
        ...
        $query_materias = "SELECT m.id_materia, m.nombre_materia 
                            FROM materias m 
            ...
            <div class="buttons_list">
                ...
                if ($result_materias->num_rows > 0) {
                    while ($materia = $result_materias->fetch_assoc()) {
                        ...
                        echo '<form method="GET" action="/classcheck_github/ui_maestro/grupo_tutorado/alumno_tutorado.php" style="display:inline;">
