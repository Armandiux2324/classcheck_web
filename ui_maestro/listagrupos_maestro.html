    ...
    <main>
        ...
        <div class="content">
            <div class="buttons_list">
                ...
                <p class="p_instrucciones">Despliegue el nombre de la materia para ver los grupos.</p>
                <div class="materia">
                    <button class="materia-button" onclick="toggleGrupos('grupo1')">Materia 1 ▼</button>
                    <div id="grupo1" class="grupo-container">
                        <p class="p_instrucciones">Pulse el botón del grupo para ver la lista de alumnos.</p>
                        <button class="button-content" onclick="redirectToListaAlumnos(event)"><strong>Grupo A</strong></button><br>
                        <button class="button-content" onclick="redirectToListaAlumnos(event)"><strong>Grupo B</strong></button>
                    </div>
                </div>
                <div class="materia">
                ...
                <div class="materia">
                    ...
                    <div id="grupoX" class="grupo-container">
                        <p class="p_instrucciones">Pulse el botón del grupo para ver la lista de alumnos.</p>
                        <button class="button-content" onclick="redirectToListaAlumnos(event)"><strong>Grupo A</strong></button><br>
                        <button class="button-content" onclick="redirectToListaAlumnos(event)"><strong>Grupo B</strong></button><br><br>
                    </div>
                </div>
            </div>
        </div>
