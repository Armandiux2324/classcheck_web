...
<head>
    ...
    <?php
    require_once $_SERVER['DOCUMENT_ROOT'] . '/classcheck_github/php/php_maestro/pass_change.php';
    ?>
</head>
<body>
    <div class="login-container">
        ...
        <form method="POST">
            ...
            <button type="submit" name="submit" class="login-button"><strong>Confirmar</strong></button>
        </form>
    </div>
