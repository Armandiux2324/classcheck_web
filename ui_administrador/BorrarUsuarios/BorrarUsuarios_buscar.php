...
<head>
    ...
    <title>ClassCheck - Borrar usuarios</title>
        ...
        <div>
            <div class="buttons-content">
                ...
                <ul id="userList" class="user-list hidden">
                    <li><button class="button-list" onclick="deleteUser(event)">Alumno</button></li>
                    <li><button class="button-list" onclick="deleteUser(event)">Maestro</button></li>
                    <li><button class="button-list" onclick="deleteUser(event)">Admin</button></li>
                </ul>
